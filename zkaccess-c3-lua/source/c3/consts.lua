...
consts.C3_COMMAND_CONNECT = {
    request = 0x76,
    reply = 0xC8
}
consts.C3_COMMAND_DISCONNECT = {
    request = 0x02,
    reply = 0xC8
}
consts.C3_COMMAND_GETPARAM = {
    request = 0x04,
    reply = 0xC8
}
consts.C3_COMMAND_DATATABLECFG = {
    request = 0x06,
    reply = 0xC8
}
consts.C3_COMMAND_CONTROL = {
    request = 0x05,
    reply = 0xC8
}
consts.C3_COMMAND_RTLOG = {
    request = 0x0B,
    reply = 0xC8
}
...
consts.C3_CONTROL_OPERATION = {
    [consts.C3_CONTROL_OPERATION_OUTPUT] = "Output operation (door or auxilary)",
...
consts.C3_CONTROL_OUTPUT_ADDRESS = {
    [consts.C3_CONTROL_OUTPUT_ADDRESS_DOOR_OUTPUT] = "Door output",
    [consts.C3_CONTROL_OUTPUT_ADDRESS_AUX_OUTPUT] = "Auxiliary output"
}

-- Event values
consts.C3_VERIFIED_MODE = {
    [0] = "None",
    [1] = "Only finger",
    [3] = "Only password",
    [4] = "Only card",
...
consts.C3_INOUT_STATUS = {
    [consts.C3_INOUT_STATUS_ENTRY] = "Entry",
    [consts.C3_INOUT_STATUS_EXIT] = "Exit",
    [consts.C3_INOUT_STATUS_NONE] = "None"
}

consts.C3_ALARM_STATUS = {
    [0] = "None",
    [1] = "Alarm",
...
consts.C3_DSS_STATUS = {
    [consts.C3_DSS_STATUS_UNKNOWN] = "No Door Status Sensor",
