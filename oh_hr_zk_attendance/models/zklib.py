...
class ZKLib:
    ...
    def __init__(self, ip, port):
        ...
        self.userdata = []
        self.attendancedata = []
        self.nga = ZKNga(self.session_id)
    ...
    def parameters(self, parameters):
        return zkparameters(self, parameters)
    ...
    def getAttendance(self):
        ...
        # my_thread = Thread(target=zkgetattendance, args=(self,))
        # my_thread.start()
        return zkgetattendance(self)

    def getDeviceData(self, parameters=None):
        return zkdevicedata(self, parameters)
