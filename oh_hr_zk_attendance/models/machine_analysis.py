...
class ZkMachine(models.Model):
    ...
    punch_type = fields.Selection([('1', 'Check In'),
                                    ...
                                    ('4','Check In'),
                                    ('101', 'Check Out'),
                                    ('0','Check In')], string='Punching Type')

    attendance_type = fields.Selection([('0', 'Check In'),
                                   ('1', 'Check Out'),
                                   ('2', 'Break Out'),
                                   ('3', 'Break In'),
                                   ('4', 'Overtime In'),
                                   ('5', 'Overtime Out')], string='Punching Type Hidden')

    punching_time = fields.Date(string='Punching Date')
    
    timing = fields.Char(string="Time")
